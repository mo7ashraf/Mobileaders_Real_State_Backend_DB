...
class NotificationController extends Controller {
  public function index(Request $r){ $star=$r->boolean('starred',false); $q=Notification::query(); if($star) $q->where('starred',true); return response()->json($q->orderBy('created_at','desc')->get()); }
